...
const plans = [
  ...
  },
  {
    ...
    description: 'Managed by us, in the region of your choice. 14-day free trial.',
    cta: { label: 'Start free trial', href: 'mailto:hello@ravencloak.org?subject=Raven%20Pro%20trial', variant: 'solid' as const, color: 'accent' as const },
    features: [
      ...
      'Minimum 5 seats · annual billing saves ~17%',
    ],
    highlight: true,
  },
  {
    ...
    cta: { label: 'Talk to sales', href: 'mailto:sales@ravencloak.org?subject=Raven%20Enterprise', variant: 'outline' as const, color: 'ink' as const },
    features: [
      'Everything in Pro',
      'SSO (SAML, OIDC)',
      ...
      'Minimum 20 seats · invoiced annually',
    ],
  },
]
