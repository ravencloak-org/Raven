...
onboaridng keeps failing even though the org is being created as i get duplicate error while retrying but otherwise I'm nost sure whether the file I upload was ingested or not. please fix all fo this asap. i want you to test everything out yourself after loggin in

### Prompt 97

keeps showing me No workspaces yet
Complete onboarding to set up your first workspace and knowledge base.

### Prompt 98

did you create a PR with all the fixes

### Prompt 99

listVoiceSessions failed: 403 https://app.ravencloak.org/orgs/eb8e3065-fc3e-4207-a403-07a032dc5251/voice No workspaces yet
Complete onboarding to set up your first workspace and knowledge base.
...
you try it, it's still throwing 500. use chrome extension or playwright and test it yourself
...
i already did via the ui

### Prompt 114

I want the ui functional

### Prompt 115

not allowing to create provider
