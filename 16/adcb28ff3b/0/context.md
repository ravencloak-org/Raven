...
Docker Build & Push / Build go-apiExpected — Waiting for status to be reported
Required
Docker Build & Push / Build python-workerExpected — Waiting for status to be reported
Required
Frontend CI / Lint & BuildExpected — Waiting for status to be reported
Required
Frontend CI / Playwright E2EExpected — Waiting for status to be reported
Required
Go CI / Build & TestExpected — Waiting for status to...
...
Loading
Docker Build & Push / Build go-api (pull_request)
Docker Build & Push / Build go-api (pull_request)Started 1 minute ago — This check has started...
Loading
Docker Build & Push / Build python-worker (pull_request)
Docker Build & Push / Build python-worker (pull_request)Started 1 minute ago — This check has started...
Loading
Go CI / Build & Test (pull_request)
Go CI / Build & Test (pull_request)Started 1 minute ago — This check has started... Why are Go actions running?

### Prompt 70

How do I use undercover mode in Claude?

### Prompt 71

Basically, commit without making it look like it's an AI agent who's working, and don't add your Claude as a user in the commits and stuff.
