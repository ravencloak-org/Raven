...
func (q *QuotaChecker) CheckKBQuota(ctx context.Context, orgID string) error {
	...
	if err != nil {
		quotaCheckFailures.Add(1)
		slog.WarnContext(ctx, "quota check failed, allowing request", "check", "kb_subscription", "org_id", orgID, "error", err, "total_failures", quotaCheckFailures.Load())
		return nil
	}
	...
	if err != nil {
		quotaCheckFailures.Add(1)
		slog.WarnContext(ctx, "quota check failed, allowing request", "check", "kb_count", "org_id", orgID, "error", err, "total_failures", quotaCheckFailures.Load())
		return nil
	}
...
func (q *QuotaChecker) CheckSeatQuota(ctx context.Context, orgID string) error {
	...
	if err != nil {
		quotaCheckFailures.Add(1)
		slog.WarnContext(ctx, "quota check failed, allowing request", "check", "seat_subscription", "org_id", orgID, "error", err, "total_failures", quotaCheckFailures.Load())
		return nil
	}
	...
	if err != nil {
		quotaCheckFailures.Add(1)
		slog.WarnContext(ctx, "quota check failed, allowing request", "check", "seat_count", "org_id", orgID, "error", err, "total_failures", quotaCheckFailures.Load())
		return nil
	}
...
func (q *QuotaChecker) CheckVoiceMinuteQuota(ctx context.Context, orgID string) error {
	...
	if err != nil {
		quotaCheckFailures.Add(1)
		slog.WarnContext(ctx, "quota check failed, allowing request", "check", "voice_subscription", "org_id", orgID, "error", err, "total_failures", quotaCheckFailures.Load())
		return nil
	}
	...
	if err != nil {
		quotaCheckFailures.Add(1)
		slog.WarnContext(ctx, "quota check failed, allowing request", "check", "voice_usage", "org_id", orgID, "error", err, "total_failures", quotaCheckFailures.Load())
		return nil
	}
...
func (q *QuotaChecker) GetConcurrentVoiceLimit(ctx context.Context, orgID string) int {
	...
	if err != nil {
		quotaCheckFailures.Add(1)
		slog.WarnContext(ctx, "quota check failed, defaulting to 1", "check", "concurrent_voice", "org_id", orgID, "error", err, "total_failures", quotaCheckFailures.Load())
		return 1
	}
