...
Perfect. Were the milestones and the issues also updated?

### Prompt 33

Is our discussion about Airbyte and the connectors also included in this? By this I mean the issues the readme Milestone and issues

### Prompt 34

But I don't think, being from India, I can get a Stripe account. Stripe is not officially supported in India. We might have to look at some alternatives which are both internationally acceptable global payment systems as well as something which is domestic, like the UPI or the RuPay credit card.
